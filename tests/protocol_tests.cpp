...
int main() {
    ...
    source.room=net::RoomState::voting;source.mode=net::GameMode::teams;source.vote_deadline_us=555555;source.eligible_voters=3;source.teams_votes=2;source.ffa_votes=1;source.team_count=4;source.friendly_fire=true;
    ...
    require(decoded.players[0].team==2);require(decoded.players[0].round_kills==4);require(decoded.room==net::RoomState::voting);require(decoded.teams_votes==2);require(decoded.team_count==4);require(decoded.friendly_fire);
