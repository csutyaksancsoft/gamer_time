...
int main(){
    ...
    require(std::fabs(entity_animation::melee_rotation_radians(0,250000))<0.0001f);require(std::fabs(entity_animation::melee_rotation_radians(125000,250000)+3.14159265f)<0.0001f);require(std::fabs(entity_animation::melee_rotation_radians(250000,250000)+6.28318531f)<0.0001f);
